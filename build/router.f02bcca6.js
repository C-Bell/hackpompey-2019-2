...
function h(n, l, u) {
  var i,
      ...
      f,
      r = arguments;
  if (l = s({}, l), arguments.length > 3) for (u = [u], i = 3; i < arguments.length; i++) u.push(r[i]);
  if (null != u && (l.children = u), null != n && null != n.defaultProps) for (t in n.defaultProps) void 0 === l[t] && (l[t] = n.defaultProps[t]);
  return f = l.key, null != (o = l.ref) && delete l.ref, null != f && delete l.key, v(n, l, f, o);
}
...
function g(l) {
  (!l.__d && (l.__d = !0) && 1 === u.push(l) || t !== n.debounceRendering) && (t = n.debounceRendering, (n.debounceRendering || i)(k));
}
...
function _(n, l, u, i, t, o, f, c, s) {
  ...
  if (c == r && (c = null != o ? o[0] : _ ? m(u, 0) : null), h = 0, l.__k = b(l.__k, function (u) {
    if (null != u) {
      ...
      if (d = T(n, u, p = p || r, i, t, o, f, c, s), (v = u.ref) && p.ref != v && (g || (g = [])).push(v, u.__c || d, u), null != d) {
...
function P(n, l, u, i, t) {
  var o, f, r, e, c;
  if ("key" === (l = t ? "className" === l ? "class" : l : "class" === l ? "className" : l) || "children" === l) ;else if ("style" === l) {
    ...
    n: if ("function" == typeof P) {
      if (k = u.props, x = (a = P.contextType) && t[a.__c], C = a ? x ? x.props.value : a.__p : t, i.__c ? g = (h = u.__c = i.__c).__p = h.__E : ("prototype" in P && P.prototype.render ? u.__c = h = new P(k, C) : (u.__c = h = new y(k, C), h.constructor = P, h.render = D), x && x.sub(h), h.props = k, h.state || (h.state = {}), h.context = C, h.__n = t, v = h.__d = !0, h.__h = []), null == h.__s && (h.__s = h.state), null != P.getDerivedStateFromProps && s(h.__s == h.state ? h.__s = s({}, h.__s) : h.__s, P.getDerivedStateFromProps(k, h.__s)), p = h.props, m = h.state, v) null == P.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && h.__h.push(h.componentDidMount);else {
        if (null == P.getDerivedStateFromProps && null == h.__e && null != h.componentWillReceiveProps && h.componentWillReceiveProps(k, C), !h.__e && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(k, h.__s, C)) {
          for (h.props = k, h.state = h.__s, h.__d = !1, h.__v = u, u.__e = i.__e, u.__k = i.__k, a = 0; a < u.__k.length; a++) u.__k[a] && (u.__k[a].__p = u);
      ...
      h.context = C, h.props = k, h.state = h.__s, (a = n.__r) && a(u), h.__d = !1, h.__v = u, h.__P = l, a = h.render(h.props, h.state, h.context), u.__k = b(null != a && a.type == d && null == a.key ? a.props.children : a), null != h.getChildContext && (t = s(s({}, t), h.getChildContext())), v || null == h.getSnapshotBeforeUpdate || (w = h.getSnapshotBeforeUpdate(p, m)), _(l, u, i, t, o, f, r, e, c), h.base = u.__e, h.__h.length && r.push(h), g && (h.__E = h.__p = null), h.__e = null;
...
function j(n, l, u, i, t, o, f, c) {
  ...
  if (null === l.type) null != o && (o[o.indexOf(n)] = null), d !== y && (n.data = y);else if (l !== u) {
    if (null != o && (o = e.slice.call(n.childNodes)), h = (d = u.props || r).dangerouslySetInnerHTML, v = y.dangerouslySetInnerHTML, !c) {
      if (d === r) for (d = {}, p = 0; p < n.attributes.length; p++) d[n.attributes[p].name] = n.attributes[p].value;
      (v || h) && (v && h && v.__html == h.__html || (n.innerHTML = v && v.__html || ""));
    }

    x(n, y, d, t, c), l.__k = l.props.children, v || _(n, l, u, i, "foreignObject" !== l.type && t, o, f, r, c), c || ("value" in y && void 0 !== y.value && y.value !== n.value && (n.value = null == y.value ? "" : y.value), "checked" in y && void 0 !== y.checked && y.checked !== n.checked && (n.checked = y.checked));
  }
  return n;
}
...
function H(l, u, i) {
  var t, f, c;
  n.__p && n.__p(l, u), f = (t = i === o) ? null : i && i.__k || u.__k, l = h(d, null, [l]), c = [], T(u, (t ? u : i || u).__k = l, f || r, r, void 0 !== u.ownerSVGElement, i && !t ? [i] : f ? null : e.slice.call(u.childNodes), c, i || r, t), $(c, l);
}
...
exports.options = n = {}, exports.isValidElement = l = function (n) {
  ...
  ("function" != typeof n || (n = n(u, this.props))) && s(u, n), null != n && this.__v && (this.__e = !1, l && this.__h.push(l), g(this));
}, y.prototype.forceUpdate = function (n) {
  this.__v && (this.__e = !0, n && this.__h.push(n), g(this));
}, y.prototype.render = d, u = [], i = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, t = n.debounceRendering, n.__e = function (n, l, u) {
  for (var i; l = l.__p;) if ((i = l.__c) && !i.__p) try {
...
},{"preact":"../../node_modules/preact/dist/preact.module.js"}],"app/Layout.tsx":[function(require,module,exports) {
"use strict";
...
},{}],"app/pages/Home.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  Home.prototype.render = function (_, state) {
    return h("div", null, h("h1", null, "Home"), h("p", null, "The time is: ", state.time.toLocaleString()));
  };
...
},{"preact":"../../node_modules/preact/dist/preact.module.js"}],"app/router.tsx":[function(require,module,exports) {
"use strict";
...
var preact_router_1 = __importDefault(require("preact-router")); // Local Imports


var Layout_1 = __importDefault(require("./Layout"));

var Home_1 = __importDefault(require("./pages/Home")); // quick fix as support for preact and parcel is iffy


window.h = preact_1.h;

var App = function App() {
  return h(Layout_1.default, null, h(preact_router_1.default, null, h(Home_1.default, {
    path: "/"
  })));
...
if (entry) preact_1.render(h(App, null), entry); // register a SW based on
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","preact":"../../node_modules/preact/dist/preact.module.js","preact-router":"../../node_modules/preact-router/dist/preact-router.es.js","./Layout":"app/Layout.tsx","./pages/Home":"app/pages/Home.tsx"}]},{},["app/router.tsx"], null)
//# sourceMappingURL=/router.f02bcca6.js.map