  ...
  render() {
    ...
    return (
      <div className="hello-world">
        ...
        <img className={this.state.recycle.glass > 0  ? "shown" : "hidden"} src="glassclr.png" alt="glass colour" height="42" width="42"></img>
        <img className={this.state.recycle.metal > 0 ? "shown" : "hidden"} src="metalclr.png" alt="metal colour" height="42" width="42"></img>
        <img className={this.state.recycle.paper >0? "shown" : "hidden"} src="paperclr.png" alt=" paper colour" height="42" width="42"></img>
        <img className={this.state.recycle.organic>0 ? "shown" : "hidden"} src="organicclr.png" alt="organic colour" height="42" width="  42"></img>
        </div>
