  ...
  render() {
    ...
    return (
      <div className="hello-world">
        ...
        <img className={this.state.recycle.plastic ? "shown" : "hidden"} src="plasticclr.png" alt="plastic colour" height="42" width="42"></img>
        <img className={this.state.recycle.glass ? "shown" : "hidden"} src="glassclr.png" alt="glass colour" height="42" width="42"></img>
        <img className={this.state.recycle.metal ? "shown" : "hidden"} src="metalclr.png" alt="metal colour" height="42" width="42"></img>
        <img className={this.state.recycle.paper ? "shown" : "hidden"} src="paperclr.png" alt=" paper colour" height="42" width="42"></img>
        <img className={this.state.recycle.organic ? "shown" : "hidden"} src="organicclr.png" alt="organic colour" height="42" width="  42"></img>
        </div>
